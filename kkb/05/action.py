...
"""
# 加载小样本
user_log = pd.read_csv(os.path.join(BASE_DIR, 'data_format1_small', 'sample_user_log.csv'), dtype={'time_stamp':'str'})
user_info = pd.read_csv(os.path.join(BASE_DIR, 'data_format1_small', 'sample_user_info.csv'))
train_data1 = pd.read_csv(os.path.join(BASE_DIR, 'data_format1_small', 'train.csv'))
submission = pd.read_csv(os.path.join(BASE_DIR, 'data_format1_small', 'test.csv'))
train_data = pd.read_csv(os.path.join(BASE_DIR, 'data_format2', 'train_format2.csv'))
...
matrix['label'] = matrix['label'].astype('float64')
...
sf1 = SparseFeat('hist_merchant_id', vocabulary_size=19111+1,
        embedding_dim=8, embedding_name='merchant_id')
sf2 = SparseFeat('hist_action_type', vocabulary_size=4+1,
        embedding_dim=4, embedding_name='action_type')
feature_columns += [VarLenSparseFeat(sf1, maxlen=M), VarLenSparseFeat(sf2, maxlen=M)]
